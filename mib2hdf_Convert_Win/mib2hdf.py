...
def convert(beamline, year, visit, mib_files, folder = None):
    ...
    if folder:
        raw_location = os.path.join('\\e02-storage','data', year, visit, 'Merlin', os.path.relpath(folder))
    else:
        raw_location = os.path.join('\\e02-storage','data', year, visit, 'Merlin')  
        
    proc_location = os.path.join('\\e02-storage','data', year, visit, 'processing', 'Merlin')
